...
from mmt.utils.torchtools import count_num_param
...
def main_worker(args):
    ...
    print("Test on target domain:")
    evaluator.evaluate(test_loader_target, dataset_validation.query, dataset_validation.gallery, cmc_flag=True,
                       rerank=args.rerank)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-dt', '--dataset-target', type=str, default='target_training',
                        choices=datasets.names())
    ...
    parser.add_argument('--num-instances', type=int, default=4,
                        help="each minibatch consist of "
                             ...
                             "default: 0 (NOT USE)")
    # model
    parser.add_argument('-a', '--arch', type=str, default='myresnet',
